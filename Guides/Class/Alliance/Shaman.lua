...
step
  only Shaman
  talk Sulaa##17219
  accept Call of Fire##9462 |goto The Exodar 32.25,23.87
step
  only Shaman
  talk Tuluun##17212
...
step
  ...
  accept Call of Water##9502 |goto Ironforge 55.45,28.92
step
  only Draenei Shaman
  talk Farseer Javad##23127
  accept Call of Air##9547 |goto Ironforge 55.45,28.92
step
  only Draenei Shaman
  talk Sulaa##17219
  accept Call of Air##9551 |goto The Exodar 32.25,23.87
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  accept Call of Air##9552 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Farseer Umbrua##20407
  accept Call of Water##10490 |goto Stormwind City 61.83,83.98
step
  only Draenei Shaman
  talk Farseer Umbrua##20407
  accept Call of Air##10491 |goto Stormwind City 61.83,83.98
step
  only Shaman
  talk Firmanvaar##17089
...
step
  ...
  turnin Call of Earth##9449 |goto Azuremyst Isle 71.31,39.1
step
  only Shaman
  talk Tuluun##17212
...
step
  only Shaman
  talk Temper##17205
  turnin Call of Fire##9464 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Water##9502 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Air##9547 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Air##9551 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Velaada##17431
  turnin Call of Air##9552 |goto Azuremyst Isle 24.9,35.92
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Water##10490 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Air##10491 |goto The Exodar 29.72,33.26
step
  only Shaman
  talk Firmanvaar##17089
...
step
  only Shaman
  talk Spirit of the Vale##17087
  accept Call of Earth##9450 |goto Azuremyst Isle 71.31,39.1
step
  only Shaman
  talk Temper##17205
  accept Call of Fire##9465 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Velaada##17431
  accept Call of Air##9553 |goto Azuremyst Isle 24.9,35.92
step
  only Draenei Shaman
  talk Aqueous##17275
...
step
  only Shaman
  note Slay 4 Restless Elements of Earth and then return to the Spirit of the Vale at the Sacred Grove in Ammen Vale.
  kill Restless Spirit of Earth##17179 |q 9450 |goto Azuremyst Isle 70.17,36.6
step
  only Shaman
  note Retrieve the Ritual Torch and return it to Temper at Emberglade on Azuremyst Isle.
  collect Ritual Torch##23733 |q 9465 |goto Azuremyst Isle 48.1,13.99 |tip {dropsfrom}Crazed Wildkin
step
  only Draenei Shaman
...
step
  only Shaman
  talk Spirit of the Vale##17087
  turnin Call of Earth##9450 |goto Azuremyst Isle 71.31,39.1
step
  only Shaman
  talk Temper##17205
  turnin Call of Fire##9465 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Susurrus##17435
  turnin Call of Air##9553 |goto Azuremyst Isle 22.31,32.55
step
  only Draenei Shaman
  talk Aqueous##17275
...
step
  only Shaman
  talk Spirit of the Vale##17087
  accept Call of Earth##9451 |goto Azuremyst Isle 71.31,39.1
step
  only Shaman
  talk Temper##17205
  accept Call of Fire##9467 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Susurrus##17435
  accept Call of Air##9554 |goto Azuremyst Isle 22.31,32.55
step
  only Draenei Shaman
  talk Aqueous##17275
...
step
  only Shaman
  note Retrieve Hauteur's Ashes and then return them and the Ritual Torch to Temper at Emberglade on Azuremyst Isle. Remember that you can use the Orb of Returning to teleport back to Temper once you have the ashes.
  collect Hauteur's Ashes##23688 |q 9467 |goto Azuremyst Isle 59.65,17.97 |tip {dropsfrom}Hauteur
step
  only Draenei Shaman
...
step
  only Shaman
  talk Temper##17205
  turnin Call of Fire##9467 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
  turnin Call of Air##9554 |goto The Exodar 29.72,33.26
step
  only Draenei Shaman
  talk Aqueous##17275
...
step
  only Shaman
  talk Temper##17205
  accept Call of Fire##9468 |goto Azuremyst Isle 59.65,17.97
step
  only Draenei Shaman
  talk Aqueous##17275
...
step
  ...
  turnin Call of Fire##9461 |goto The Exodar 32.87,54.5
step
  only Draenei Shaman
  talk Farseer Nobundo##17204
...
step
  only Shaman
  talk Prophet Velen##17468
  accept Call of Fire##9555 |goto The Exodar 32.87,54.5
step
  talk Mux Manascrambler##16014
...
step
  only Shaman
  talk Farseer Nobundo##17204
  turnin Call of Fire##9555 |goto The Exodar 29.72,33.26
step
  talk Mux Manascrambler##16014
...
step
  ...
  collect Boots of Elements##16670 |q 10496 |goto Blackrock Spire - Dungeon -1,-1 |elite |tip {dropsfrom}Highlord Omokk
step
  only Shaman
  talk Deliana##16013
