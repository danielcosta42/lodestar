...
step
  ...
  accept Surena Caledon##1688 |goto Stormwind City 25.25,78.56
step
  only Warlock
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  accept Seeking Strahad##1798 |goto Stormwind City 25.25,78.56
step
  only Warlock
...
step
  ...
  collect 3 Feather Charm##6753 |q 1599 |goto Dun Morogh 30.23,81.06 |tip {dropsfrom}Frostmane Novice
step
  only Warlock
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin Gakin's Summons##1685 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin Surena Caledon##1688 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin The Slaughtered Lamb##1715 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin Gakin's Summons##1717 |goto Stormwind City 25.25,78.56
step
  only Warlock
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  accept The Binding##1689 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Gakin the Darkbinder##6122
  accept Devourer of Souls##1716 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Strahad Farsan##6251
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin The Binding##1689 |goto Stormwind City 25.25,78.56
step
  only Warlock
...
step
  ...
  collect Heartswood##6912 |q 1738 |goto Ashenvale 31.6,31.18 |tip {dropsfrom}Dark Strand Excavator, Heartswood
step
  only Warlock
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  turnin Heartswood##1738 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Krom Stoutarm##6294
  turnin Tome of the Cabal##1802 |goto Ironforge 74.19,9.39
step
  only Warlock
...
step
  only Warlock
  talk Gakin the Darkbinder##6122
  accept The Binding##1739 |goto Stormwind City 25.25,78.56
step
  only Warlock
  talk Krom Stoutarm##6294
...
step
  ...
  collect Rod of Channeling##6930 |q 1804 |goto Wetlands 53.09,54.36 |tip {dropsfrom}Dragonmaw Shadowwarder, Dragonmaw Bonewarder
step
  only Warlock
...
step
  only Warlock
  talk Strahad Farsan##6251
  turnin Tome of the Cabal##1804 |goto The Barrens 62.63,35.5
step
  only Warlock
