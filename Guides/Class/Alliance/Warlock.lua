...
step
  ...
  collect 3 Filled Containment Coffer##7292 |q 1920 |goto Stormwind City 38.62,79.3 |tip {dropsfrom}Filled Containment Coffer
step
  only Warlock
  note Bring Ur's Treatise on Shadow Magic to High Sorcerer Andromath in Stormwind.
  collect Ur's Treatise on Shadow Magic##7266 |q 1938 |goto Redridge Mountains 78.86,47.61 |tip {dropsfrom}Ur's Treatise on Shadow Magic
step
  only Warlock
