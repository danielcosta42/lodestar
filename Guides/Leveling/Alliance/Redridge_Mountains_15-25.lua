...
step
  ...
  collect Head of Targorr##3630 |q 386 |goto The Stockade - Dungeon -1,-1 |tip {dropsfrom}Targorr the Dread
step
  only Warrior
...
step
  ...
  collect Tharil'zun's Head##1260 |q 19 |goto Redridge Mountains 69.45,59.41 |tip {dropsfrom}Tharil'zun
step
  talk Foreman Oslow##341
