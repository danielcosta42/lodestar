...
ns:RegisterGuide("Leveling/Horde/Raid Ready - Boosted 60-70", {
	faction = "Horde",
	range = {60, 70},
...
step
  note {rrrepgoal}Thrallmar
step
  note {rrtoshatt}Stonebreaker Hold
step
  home Shattrath City
step
...
step
  note {rrcheck1}
step
  note {rrflytrain}Shadowmoon Village
step
