...
step
  ...
  collect A Husband's Revenge##3613 |q 530 |goto Undercity 62.01,42.75
step
...
step
  ...
  collect Leaders of the Fang##9738 |q 914 |goto Thunder Bluff 75.65,31.61
step
...
step
  collect Chen's Empty Keg##3238 |goto The Barrens 54.71,27.3 |tip Loot the quest item here — it starts the quest.
  accept Chen's Empty Keg##819 |goto The Barrens 54.71,27.3
step
...
step
  ...
  collect 8 Dig Rat##5051 |q 862 |goto The Barrens 49.27,84.47
step
...
step
  ...
  accept Envoy to the Horde##9621 |goto Silvermoon City 53.8,20.23
step
  talk Lor'themar Theron##16802
  accept Envoy to the Horde##9812 |goto Silvermoon City 53.8,20.23
step
...
step
  ...
  accept Report to Splintertree Post##9428 |goto Orgrimmar 31.61,38.38
step
...
step
  ...
  accept The Ashenvale Hunt##742 |goto Thunder Bluff 44.33,58.76
step
  only Tauren
...
step
  kill Owatanka##3473 |goto The Barrens 49.4,62.13 |tip Loot the quest item here — it starts the quest.
  accept Owatanka##884 |goto The Barrens 49.4,62.13
step
...
step
  ...
  turnin Report to Splintertree Post##9428 |goto Ashenvale 71.33,67.69 |tip {turninat}Ashenvale
step
  talk Warcaller Gorlach##10880
  accept The Ashenvale Hunt##235 |goto Orgrimmar 37.56,75.36
step
  talk Gann Stonespire##3341
  accept Gann's Reclamation##843 |goto The Barrens 45.89,77.0
step
  kill Washte Pawne##3472 |goto The Barrens 44.81,79.87 |tip Loot the quest item here — it starts the quest.
  accept Washte Pawne##885 |goto The Barrens 44.81,79.87
step
  kill Silithid Harvester##3253 |goto The Barrens 43.07,70.08 |tip Loot the quest item here — it starts the quest.
  accept The Harvester##897 |goto The Barrens 43.07,70.08
step
  kill Aean Swiftriver##5797 |goto The Barrens 48.51,79.69 |elite |tip Loot the quest item here — it starts the quest.
  accept The Runed Scroll##3513 |goto The Barrens 48.51,79.69
step
...
step
  ...
  accept Report to Tarren Mill##9425 |goto Undercity 57.77,90.56
step
...
step
  ...
  turnin Envoy to the Horde##9812 |goto Undercity 58.05,91.79 |tip {turninat}Undercity
step
  only BloodElf
  talk Lady Sylvanas Windrunner##10181
  turnin Envoy to the Horde##9621 |goto Undercity 58.05,91.79 |tip {turninat}Undercity
step
...
step
  only BloodElf
  talk Lady Sylvanas Windrunner##10181
  accept Meeting the Warchief##9626 |goto Undercity 58.05,91.79
step
  talk Lady Sylvanas Windrunner##10181
  accept Meeting the Warchief##9813 |goto Undercity 58.05,91.79
step
  talk Raleigh Andrean##2050
...
step
  ...
  turnin The Ashenvale Hunt##742 |goto Ashenvale 73.78,61.46 |tip {turninat}Ashenvale
step
  talk Senani Thunderheart##12696
  turnin The Ashenvale Hunt##235 |goto Ashenvale 73.78,61.46 |tip {turninat}Ashenvale
step
  talk Senani Thunderheart##12696
...
step
  ...
  collect Crossroads' Supply Crates##12708 |q 5041 |goto The Barrens 59.18,25.86
step
  only Tauren
  talk Devrak##3615
...
step
  only BloodElf
  talk Advisor Duskingdawn##17092
  turnin Report to Tarren Mill##9425 |goto Hillsbrad Foothills 62.58,20.81 |tip {turninat}Hillsbrad Foothills
step
  only Warrior
  talk Uzzek##5810
...
step
  only Undead Priest
  talk Aelthalyste##4606
  turnin Devouring Plague##5646 |goto Undercity 49.26,17.12 |tip {turninat}Undercity
step
  only Undead Priest
  talk Aelthalyste##4606
...
step
  talk Thrall##4949
  turnin Meeting the Warchief##9813 |goto Orgrimmar 31.73,37.82 |tip {turninat}Orgrimmar
step
...
step
  only BloodElf
  talk Thrall##4949
  turnin Meeting the Warchief##9626 |goto Orgrimmar 31.73,37.82 |tip {turninat}Orgrimmar
step
  talk Seereth Stonebreak##4049
...
step
  only BloodElf
  talk Thrall##4949
  accept Allegiance to the Horde##9627 |goto Orgrimmar 31.73,37.82
step
...
step
  only Troll Priest
  talk Ur'kyo##6018
  turnin Shadowguard##5680 |goto Orgrimmar 35.59,87.82 |tip {turninat}Orgrimmar
step
  talk Feegly the Exiled##3421
...
step
  only BloodElf
  talk Lor'themar Theron##16802
  turnin Allegiance to the Horde##9627 |goto Silvermoon City 53.8,20.23 |tip {turninat}Silvermoon City
step
