...
ns:RegisterGuide("Reputation/Alliance/Lower City", {
	faction = "Alliance",
...
step
  ...
  accept Into the Heart of the Labyrinth##10095 |goto Shadow Labyrinth - Dungeon -1,-1
step
...
step
  ...
  collect Soul Device##27480 |q 10091 |goto Shadow Labyrinth - Dungeon -1,-1
step
...
step
  talk Rilak the Redeemed##22292
  turnin Secrets of the Arakkoa##10863 |goto Shattrath City 52.54,21.01
step
  talk Mekeda##22370
